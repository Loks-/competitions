...
public:
	...
	TSelf operator+(TSelf rvalue) const { return TBase::Add(value, rvalue.value); }
	TSelf& operator+=(TSelf rvalue) { value += rvalue.value; value %= mod; return *this; }
	TSelf operator-() const { return TBase::Minus(value); }
	TSelf operator-(TSelf rvalue) const { return TBase::Sub(value, rvalue.value); }
	TSelf& operator-=(TSelf rvalue) { value += (mod - rvalue.value); value %= mod; return *this; }
	TSelf operator*(TSelf rvalue) const { return TBase::Mult(value, rvalue.value); }
	TSelf& operator*=(TSelf rvalue) { value = TBase::Mult(value, rvalue.value); return *this; }
	TSelf operator/(TSelf rvalue) const { return TBase::Div(value, rvalue.value); }
	TSelf& operator/=(TSelf rvalue) { value = TBase::Div(value, rvalue.value); return *this; }
