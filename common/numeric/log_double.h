...
public:
    ...
    static LogDouble MakeLog(double log_x) { LogDouble t; t.SetLog(log_x); return t; }

    bool operator<(const LogDouble& r) const { return value < r.value; }
    bool operator<=(const LogDouble& r) const { return !(r.value < value); }
    
    LogDouble& operator+=(const LogDouble& r) { *this = (*this + r); return *this; }
    LogDouble& operator-=(const LogDouble& r) { *this = (*this - r); return *this; }
    LogDouble& operator*=(const LogDouble& r) { value += r.value; return *this; }
    LogDouble& operator/=(const LogDouble& r) { value -= r.value; return *this; }
    ...
    LogDouble operator*(const LogDouble& r) const { LogDouble t(*this); t *= r; return t; }
    LogDouble operator/(const LogDouble& r) const { LogDouble t(*this); t /= r; return t; }
};
