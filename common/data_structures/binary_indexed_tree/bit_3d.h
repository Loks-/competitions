...
class BIT_3D {
 ...
 public:
  constexpr BIT_3D(size_t _size1, size_t _size2, size_t _size3)
      : size1(_size1), size2(_size2), size3(_size3) {
    values.resize(size1 * size2 * size3);
  }

  constexpr void Reset(size_t new_size1, size_t new_size2, size_t new_size3) {
    size1 = new_size1;
    size2 = new_size2;
    size3 = new_size3;
    values.resize(size1 * size2 * size3);
  ...
  constexpr void Add(size_t index1, size_t index2, size_t index3,
  ...
  constexpr TValue Sum(size_t end1, size_t end2, size_t end3) const {
    TValue sum = TValue();
  ...
  constexpr TValue Sum(size_t b1, size_t b2, size_t b3, size_t e1, size_t e2,
                       size_t e3) const {
  ...
  constexpr TValue Get(size_t index1, size_t index2, size_t index3) const {
