...
class Arithmetic {
 ...
 protected:
  ...
  static constexpr TValue ApplyTI(TValue value, TValue mod, MetaType<int64_t>) {
    return ApplyS(value, mod);
  }

 public:
  static constexpr TValue ApplyT(TValue value, TValue mod) {
    return ApplyTI(value, mod, MetaType<TValue>());
  }
 ...
 protected:
  ...
  static constexpr TValue SqrI(TValue value, TValue mod, MetaTrue) {
    return Sqr_32(value, mod);
  }

  static constexpr TValue SqrI(TValue value, TValue mod, MetaFalse) {
    return Sqr_64(value, mod);
  }

 public:
  static constexpr TValue Mult(TValue lvalue, TValue rvalue, TValue mod) {
    return MultI(lvalue, rvalue, mod, MetaBool<is_32bit>());
  }
  ...
  static constexpr TValue Sqr(TValue value, TValue mod) {
    return SqrI(value, mod, MetaBool<is_32bit>());
  }
 ...
 protected:
  static constexpr TValue InverseI(TValue value, TValue mod, MetaTrue) {
    return Inverse_Prime(value, mod);
  }

  static constexpr TValue InverseI(TValue value, TValue mod, MetaFalse) {
 ...
 public:
  static constexpr TValue Inverse(TValue value, TValue mod) {
    return InverseI(value, mod, MetaBool<is_prime>());
  }
  ...
  static constexpr TValue Div(TValue numerator, TValue denominator,
                              TValue mod) {
    return DivI(numerator, denominator, mod, MetaBool<is_prime>());
  }
