...
public:
    ...
    PModularDiscreteLogFullMap(unsigned prime, unsigned pprimitive) : p(prime), primitive(pprimitive) { Build(); }
    PModularDiscreteLogFullMap(unsigned prime, const TFactorization& p1_factorization) : PModularDiscreteLogFullMap(prime, FindSmallestPrimitive(prime, p1_factorization)) {}
    PModularDiscreteLogFullMap(unsigned prime) : PModularDiscreteLogFullMap(prime, Factorize(prime - 1)) {}
