...
constexpr Point<dim, T>& operator+=(Point<dim, T>& p, const Vector<dim, T>& v) {
...
template <unsigned dim, class T>
constexpr Point<dim, T> operator+(const Point<dim, T>& p,
...
template <unsigned dim, class T>
constexpr Vector<dim, T> operator-(const Point<dim, T>& p1,
