...
inline void STAddActionToSegmentI(TNode* root, const typename TNode::TInfo::TCoordinate& l, const typename TNode::TInfo::TCoordinate& r, const TActionValue& action_value)
{
...
template<class TNode, class TActionValue>
inline void STAddActionToSegment(TNode* root, const typename TNode::TInfo::TCoordinate& l, const typename TNode::TInfo::TCoordinate& r, const TActionValue& action_value)
{
