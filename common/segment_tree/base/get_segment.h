...
inline typename TNode::TInfo STGetSegmentI(TNode* root, const typename TNode::TInfo::TCoordinate& l, const typename TNode::TInfo::TCoordinate& r)
{
...
template<class TNode>
inline typename TNode::TInfo STGetSegment(TNode* root, const typename TNode::TInfo::TCoordinate& l, const typename TNode::TInfo::TCoordinate& r)
{
    using TInfo = typename TNode::TInfo;
