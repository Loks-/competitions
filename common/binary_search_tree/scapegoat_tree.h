          ...
          memory::ContiguousNodesManager<
              base::Node<Data,
                         base::SubtreeData<templates::PrependIfMissingT<
                             subtree_data::Size, AggregatorsTuple>>,
                         base::Deferred<DeferredTuple>, has_parent, true, Key>>,
          ScapegoatTree<has_parent, Data, AggregatorsTuple, DeferredTuple,
                        Key>> {
 public:
  ...
  using Self =
      ScapegoatTree<has_parent, Data, AggregatorsTuple, DeferredTuple, Key>;
  using SBTree =
