...
class BIT_3D {
 ...
 public:
  BIT_3D(unsigned _size1, unsigned _size2, unsigned _size3)
  ...
  void Add(unsigned index1, unsigned index2, unsigned index3,
  ...
  TValue Sum(unsigned b1, unsigned b2, unsigned b3, unsigned e1, unsigned e2,
             unsigned e3) const {
