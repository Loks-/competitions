...
bool TestModularFFT()
{
    ...
    std::vector<TModular> v1_fft = fft.FFT(n, v1), v2_fft = fft.FFT(n, v2), v3_fft = fft.FFT(n, v3);
    for (unsigned i = 0; i < n; ++i)
    {
    ...
    if ((v1 != fft.FFTI(n, v1_fft)) || (v2 != fft.FFTI(n, v2_fft)) || (v3 != fft.FFTI(n, v3_fft)))
    {
