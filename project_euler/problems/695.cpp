...
int main_695() {
  ...
  auto f4_112 = s1ps2;
  auto f3_112 = IntegrationAB(f4_112, 2, zero, x0 - x0 * (one - y0) / y1);
  ...
  auto f4_1131 = s1ps1;
  auto f3_1131 = IntegrationAB(f4_1131, 2, zero, x0 - x0 * y0 / y1);
  ...
  auto f4_1132 = s1p;
  auto f3_1132 = IntegrationAB(f4_1132, 2, zero, x0 * y0 / y1);
