...
int proxy(const std::string& s)
{
	...
	else if (s == "the_chosen_one_treap") return main_the_chosen_one_treap();
	...
	else if (s == "median_updates_upf_red_black") return main_median_updates_upf_red_black();
	else if (s == "median_updates_upt_red_black") return main_median_updates_upt_red_black();
	else if (s == "median_updates_upt_scapegoat") return main_median_updates_upt_scapegoat();
	...
	else if (s == "median_updates_upf_treap") return main_median_updates_upf_treap();
	else if (s == "array_and_simple_queries_splay") return main_array_and_simple_queries_splay();
	else if (s == "median_updates_upf_scapegoat") return main_median_updates_upf_scapegoat();
	else if (s == "median_updates_upt_treap") return main_median_updates_upt_treap();
	else if (s == "median_updates_upt_splay") return main_median_updates_upt_splay();
