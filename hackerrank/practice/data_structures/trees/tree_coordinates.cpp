...
int main_tree_coordinates() {
  ...
  for (unsigned i = 0; i < m; ++i) {
    ...
    unsigned d11 = t11 + t12;
    m11 = max(m11, d11);
    vl11[d11].push_back(i);
    unsigned d12 = t11 + t22;
    m12 = max(m12, d12);
    vl12[d12].push_back(i);
    unsigned d21 = t21 + t12;
    m21 = max(m21, d21);
    vl21[d21].push_back(i);
    unsigned d22 = t21 + t22;
    m22 = max(m22, d22);
    vl22[d22].push_back(i);
  }
    ...
    for (unsigned s1 = 0; s1 <= s; ++s1) {
      ...
      for (unsigned i1 : vl11[s1]) {
        for (unsigned i2 : vl22[s2]) {
          unsigned l = lca.GetDistance(vp1[i1], vp1[i2]) +
                       lca.GetDistance(vp2[i1], vp2[i2]);
